import unittest
from challenge import get_product_by_category
...
class TestExercisePart3(unittest.TestCase):
    ...
    def test_one(self):
        ...
        self.assertEqual(get_product_by_category(data, 'sweater'), expected)
    ...
    def test_two(self):
        ...
        self.assertEqual(get_product_by_category(data, 'coat'), expected)
    
    def test_three(self):
        self.assertEqual(get_product_by_category(data, 'jeans'), [])
